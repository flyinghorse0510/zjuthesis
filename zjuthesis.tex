...
\documentclass[
    ...
    % Title
    Title           = 基于磁传感器的智能手指运动追踪系统,
    TitleEng        = {{Intelligent finger motion tracking system using magnetic sensors}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
% \titletwolines{Intelligent finger motion tracking system}{using magnetic sensors}
